...
describe("ChunkConf class", function()
    ...
    it("ChunkConf happy path", function()
        ...
        -- assert.are.same(actual.textobject, user_textobject)
        assert.equals(actual.textobject.keymap, user_textobject.keymap)
        assert.equals(actual.textobject.desc, user_textobject.desc)
